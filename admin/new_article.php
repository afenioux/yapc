...
<h2>1 - Choisissez vos images</h2>
</div>
<a href="upload_photo_simple.php?id_article=<?php print $my_article['id'];?>" target="_blank">Ouvrez une nouvelle fenetre pour envoyer vos images</a>
</div><!--end of formarea-->
